...
BigAnimal retains backups for 30 days by default. You can change the retention period on the [Availability tab](../getting_started/creating_a_cluster/#availability-tab) when you create your cluster or when editing your cluster. See [Backups](../getting_started/creating_a_cluster/#backups) for more information.
...
1. Select the cluster you wish to restore on the [**Clusters**](https://portal.biganimal.com/clusters) page in the [BigAnimal](https://portal.biganimal.com) portal. 
